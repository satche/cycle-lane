			...
			<section class="report_section">
				...
				<div class="report_field">
					...
					<div class="infoFields">
						...
						<p>Il faudrait environ {{ (totalCo2Quantity / carCo2Impact).toFixed(2) }} voitures pour compenser
...
export default {
	...
	methods: {
		...
		calculateSolarPannelProduction() {
			...
			const flooredSolarPanelProduction = (solarPanelProduction / 1000) / 1000;
			this.solarPanelProduction = flooredSolarPanelProduction;
		},
		calculateCarCo2() {
