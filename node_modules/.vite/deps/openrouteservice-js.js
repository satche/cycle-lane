...
// node_modules/openrouteservice-js/dist/ors-js-client.js
var constants = {
...
var orsUtil$3 = new OrsUtil();
var OrsGeocode = class extends OrsBase {
  constructor(args) {
    super(args);
...
var OrsIsochrones = class extends OrsBase {
  constructor(args) {
    super(args);
    if (!this.defaultArgs[constants.propNames.service] && !this.requestArgs[constants.propNames.service]) {
...
var OrsMatrix = class extends OrsBase {
  constructor(args) {
    super(args);
    if (!this.defaultArgs[constants.propNames.service] && !this.requestArgs[constants.propNames.service]) {
...
var OrsDirections = class extends OrsBase {
  constructor(args) {
    super(args);
...
var orsUtil$2 = new OrsUtil();
var OrsPois = class extends OrsBase {
  constructor(args) {
    super(args);
    if (!this.defaultArgs[constants.propNames.service]) {
...
var orsUtil$1 = new OrsUtil();
var OrsElevation = class extends OrsBase {
  generatePayload(args) {
    const payload = {};
    for (const key in args) {
      if (constants.baseUrlConstituents.indexOf(key) <= -1) {
...
var orsUtil = new OrsUtil();
var OrsOptimization = class extends OrsBase {
  generatePayload(args) {
    let payload = {};
    for (const key in args) {
      if (constants.baseUrlConstituents.indexOf(key) <= -1) {
...
//# sourceMappingURL=openrouteservice-js.js.map
